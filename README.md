# text2mol
Replication of [Text2Mol: Cross-Modal Molecular Retrieval with Natural Language Queries](https://github.com/cnedwards/text2mol)
...
Watch the project presentation: [YouTube Video](https://youtu.be/f25X_zxVEwQ)
